...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			<li class="nav-item current"><a href="../dashboard"><span class="nav-icon"><i class="fa fa-users"></i></span>Tous les employés</a></li>
			...
			<li class="nav-item"><a href="../dashboard/past_employees.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Anciens employés</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">Tous les employés</div>
				<div class="top-bar">
					<div class="top-item">
